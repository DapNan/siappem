...
<table class="table table-hover">
    ...
    <tbody class="text-gray-800">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('perumahan.pengembangcetaktandaterima', $perumahan->id_perumahan) }}" class="btn btn-warning"><i class="fas fa-print"></i> Cetak</a>
                    </td>
                </tr>
                <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <embed
                    src="{{ route('perumahan.viewsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'basta']) }}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your modal content here -->
                <embed
                    src="{{ route('perumahan.viewsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'bahpl']) }}"
                    type="application/pdf" width="100%" height="500px">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your modal content here -->
                <embed
                    src="{{ route('perumahan.viewsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'bahvl']) }}"
                    type="application/pdf" width="100%" height="500px">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your modal content here -->
                <embed
                    src="{{ route('perumahan.viewsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'bastf']) }}"
                    type="application/pdf" width="100%" height="500px">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your modal content here -->
                <embed
                    src="{{ route('perumahan.viewsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'bastb']) }}"
                    type="application/pdf" width="100%" height="500px">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
