    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'surat_psu']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
...
<div class="modal fade" id="lihatdokumentapak" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'dokumen_tapak']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="lihatsuratimb" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'imb']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="lihatsuratijinlokasi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'ijin_lokasi']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="lihatnjop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'njop']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="lihatsertifikatfasum" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'sertifikat_fasum']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="lihatsuratpelepasantanah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'surat_pelepasan_tanah']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
  ...
  <div class="modal fade" id="lihatsertifikattpu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'sertifikat_tpu']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
  ...
  <div class="modal fade" id="lihatmoutpu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'mou_tpu']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
  ...
  <div class="modal fade" id="lihatmoutps" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Add your modal content here -->
          <embed src="{{ route('perumahan.lihatsurat', ['id' => $perumahan->id_perumahan, 'jenisSurat' => 'mou_tps']) }}" type="application/pdf" width="100%" height="500px"> 
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
