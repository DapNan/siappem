            ...
            <table class="text-gray-900">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td>{{ $user->nik_pemilik }}</td>
                    </tr>
                    <tr>
                        <td width="20">6. </td>
                        <td width="275">NO HP PEMILIK </td>
                        <td width="10">:</td>
                        <td>{{ $user->no_hp_pemilik }}</td>
                    </tr>
                    <tr>
                        <td width="20">7. </td>
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td>
                            <a href="{{ route('user.tampilsurat', ['id'=>$user->id, 'jenisSurat' => 'akta_pendiri']) }}"
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td>
                            <a href="{{ route('user.tampilsurat', ['id' => $user->id, 'jenisSurat' => 'npwp_perusahaan']) }}"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('user.tampilsurat', ['id' => $user->id ,'jenisSurat' => 'ktp_pendiri']) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <embed src="{{ route('user.tampilsurat', ['id' => $user->id ,'jenisSurat' => 'akta_pendiri']) }}" type="application/pdf"
    ...
    <div class="modal fade" id="lihatnpwpperusahaan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <embed src="{{ route('user.tampilsurat', ['id' => $user->id ,'jenisSurat' => 'npwp_perusahaan']) }}"
    ...
    <div class="modal fade" id="lihatktppendiri" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <embed src="{{ route('user.tampilsurat', ['id' => $user->id ,'jenisSurat' => 'ktp_pendiri']) }}"
                        type="application/pdf" width="100%" height="500px">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
